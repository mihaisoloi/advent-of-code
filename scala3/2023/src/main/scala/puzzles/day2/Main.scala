...
@main def main() =
    println(
      "Puzzle1 = " + CubeConundrum.solvePuzzle1(
        puzzleInput,
        CubeConundrum.puzzle1CubeSet
      )
    )
    println("Puzzle2 = " + CubeConundrum.solvePuzzle2(puzzleInput))

val puzzleInput = """Game 1: 4 red, 18 green, 15 blue; 17 green, 18 blue, 9 red; 8 red, 14 green, 6 blue; 14 green, 12 blue, 2 red
